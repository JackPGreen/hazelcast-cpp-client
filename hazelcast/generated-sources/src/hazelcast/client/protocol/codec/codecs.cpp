...
namespace hazelcast {
    namespace client {
        namespace protocol {
            namespace codec {
                ClientMessage client_authentication_encode(const std::string &cluster_name, const std::string *username, const std::string *password, boost::uuids::uuid uuid, const std::string &client_type, byte serialization_version, const std::string &client_hazelcast_version, const std::string &client_name, const std::vector<std::string> &labels, byte routing_mode, bool cp_direct_to_leader_routing) {
                    size_t initial_frame_size = ClientMessage::REQUEST_HEADER_LEN + ClientMessage::UUID_SIZE + ClientMessage::UINT8_SIZE + ClientMessage::UINT8_SIZE + ClientMessage::UINT8_SIZE;
                ...
                client_addclusterviewlistener_handler::client_addclusterviewlistener_handler(logger& l)
                ...
                void client_addclusterviewlistener_handler::handle(ClientMessage &msg) {
                    ...
                    if (messageType == EVENT_MEMBERS_VIEW ) {
                        auto *initial_frame = reinterpret_cast<ClientMessage::frame_header_type *>(msg.rd_ptr(ClientMessage::EVENT_HEADER_LEN));
                    ...
                    if (messageType == EVENT_MEMBER_GROUPS_VIEW ) {
                        ...
                        auto member_groups = msg.get<std::vector<std::vector<boost::uuids::uuid>>>();
                    ...
                    HZ_LOG(get_logger(), finest, (boost::format(
                ...
                client_localbackuplistener_handler::client_localbackuplistener_handler(logger& l)
                    : impl::BaseEventHandler(l) {}
                ...
                ClientMessage client_sendschema_encode(const serialization::pimpl::schema &schema) {
                    size_t initial_frame_size = ClientMessage::REQUEST_HEADER_LEN;
                    ClientMessage msg(initial_frame_size);
                    msg.set_retryable(true);
                ...
                ClientMessage client_fetchschema_encode(int64_t schema_id) {
                    size_t initial_frame_size = ClientMessage::REQUEST_HEADER_LEN + ClientMessage::INT64_SIZE;
                    ClientMessage msg(initial_frame_size, true);
                    msg.set_retryable(true);
                ...
                ClientMessage client_sendallschemas_encode(const std::vector<serialization::pimpl::schema> &schemas) {
                    size_t initial_frame_size = ClientMessage::REQUEST_HEADER_LEN;
                    ClientMessage msg(initial_frame_size);
                    msg.set_retryable(true);
                ...
                map_addentrylistenerwithpredicate_handler::map_addentrylistenerwithpredicate_handler(logger& l)
                    : impl::BaseEventHandler(l) {}
                ...
                map_addnearcacheinvalidationlistener_handler::map_addnearcacheinvalidationlistener_handler(logger& l)
                    : impl::BaseEventHandler(l) {}
                ...
                multimap_addentrylistenertokey_handler::multimap_addentrylistenertokey_handler(logger& l)
                    : impl::BaseEventHandler(l) {}
                ...
                replicatedmap_addentrylistenertokeywithpredicate_handler::replicatedmap_addentrylistenertokeywithpredicate_handler(logger& l)
                    : impl::BaseEventHandler(l) {}
                ...
                replicatedmap_addentrylistenerwithpredicate_handler::replicatedmap_addentrylistenerwithpredicate_handler(logger& l)
                    : impl::BaseEventHandler(l) {}
                ...
                replicatedmap_addentrylistenertokey_handler::replicatedmap_addentrylistenertokey_handler(logger& l)
                    : impl::BaseEventHandler(l) {}
                ...
                replicatedmap_addentrylistener_handler::replicatedmap_addentrylistener_handler(logger& l)
                    : impl::BaseEventHandler(l) {}
                ...
                replicatedmap_addnearcacheentrylistener_handler::replicatedmap_addnearcacheentrylistener_handler(logger& l)
                    : impl::BaseEventHandler(l) {}
                ...
                ClientMessage sql_close_encode(const sql::impl::query_id &query_id) {
                    size_t initial_frame_size = ClientMessage::REQUEST_HEADER_LEN;
                    ClientMessage msg(initial_frame_size);
                    msg.set_retryable(false);
                ...
                ClientMessage sql_execute_encode(const std::string &sql, const std::vector<serialization::pimpl::data> &parameters, int64_t timeout_millis, int32_t cursor_buffer_size, const std::string *schema, byte expected_result_type, const sql::impl::query_id &query_id, bool skip_update_statistics) {
                    size_t initial_frame_size = ClientMessage::REQUEST_HEADER_LEN + ClientMessage::INT64_SIZE + ClientMessage::INT32_SIZE + ClientMessage::UINT8_SIZE + ClientMessage::UINT8_SIZE;
                    ClientMessage msg(initial_frame_size);
                    msg.set_retryable(false);
                ...
                ClientMessage sql_fetch_encode(const sql::impl::query_id &query_id, int32_t cursor_buffer_size) {
                    size_t initial_frame_size = ClientMessage::REQUEST_HEADER_LEN + ClientMessage::INT32_SIZE;
                    ClientMessage msg(initial_frame_size);
                    msg.set_retryable(false);
